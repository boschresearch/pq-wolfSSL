...
enum {
    ...
    WOLFSSL_KYBER_512     = 65024,  /* values reserved for private use according to RFC8446 */
    WOLFSSL_KYBER_768     = 65025,
    WOLFSSL_KYBER_1024    = 65026,
    WOLFSSL_KYBER_MAX     = 65026,
#endif
#if defined(WOLFSSL_TLS13) && defined(HAVE_DILITHIUM)
    WOLFSSL_DILITHIUM     = 65027,  /* values reserved for private use according to RFC8446 */
#endif
#if defined(WOLFSSL_TLS13) && defined(HAVE_FALCON)
    WOLFSSL_FALCON        = 65028,  /* values reserved for private use according to RFC8446 */
#endif
#if defined(WOLFSSL_TLS13) && defined(HAVE_SPHINCS)
    WOLFSSL_SPHINCS       = 65029,  /* values reserved for private use according to RFC8446 */
#endif
#if defined(WOLFSSL_TLS13) && defined(HAVE_XMSS)
    WOLFSSL_XMSS          = 65030,  /* values reserved for private use according to RFC8446 */
#endif
};
