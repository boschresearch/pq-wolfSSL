...
enum wolfSSL_ErrorCodes {
    ...
    KYBER_KEY_ERROR              = -334,   /* Kyber key error */
    ...
    DILITHIUM_KEY_SIZE_E         = -442,   /* Dilithium key too small */
    FALCON_KEY_SIZE_E            = -443,   /* Falcon key too small */
    SPHINCS_KEY_SIZE_E           = -444,   /* Sphincs key too small */
    XMSS_KEY_SIZE_E              = -445,   /* XMSS key too small */
