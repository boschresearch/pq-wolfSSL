...
enum Misc_ASN {
    ...
    MAX_ENCODED_SIG_SZ  = 36176, //35664 + 128
#elif defined(HAVE_XMSS)
    MAX_ENCODED_SIG_SZ  = 10240 //9732,
#elif defined(HAVE_DILITHIUM)
    MAX_ENCODED_SIG_SZ  = 4595,
#elif defined(HAVE_FALCON)
    MAX_ENCODED_SIG_SZ  = 1330,
#elif !defined(NO_RSA)
    ...
    MAX_DILITHIUM_KEY_SZ = 2592,   /* Dilithium level 5 public key size */
    MAX_FALCON_KEY_SZ    = 1793,   /* Falcon-1024 public key size */
    MAX_SPHINCS_KEY_SZ   = 48,     /* Sphincs-192 public key size */
    MAX_XMSS_KEY_SZ      = 128,    /* XMSS SHA512 public key size */
    ...
    EIGHTK_BUF          = 40000,   /* Tmp buffer size           */
#if defined(HAVE_DILITHIUM)
    MAX_PUBLIC_KEY_SZ   = MAX_DILITHIUM_KEY_SZ + MAX_ALGO_SZ + MAX_SEQ_SZ * 2,
                                /* use bigger Dilithium size */
#elif defined(HAVE_FALCON)
    MAX_PUBLIC_KEY_SZ   = MAX_FALCON_KEY_SZ + MAX_ALGO_SZ + MAX_SEQ_SZ * 2,
                                /* use bigger Falcon size */
#elif defined(HAVE_XMSS)
    MAX_PUBLIC_KEY_SZ   = MAX_XMSS_KEY_SZ + MAX_ALGO_SZ + MAX_SEQ_SZ * 2,
                                /* use bigger XMSS size */
#elif defined(HAVE_SPHINCS)
    MAX_PUBLIC_KEY_SZ   = MAX_SPHINCS_KEY_SZ + MAX_ALGO_SZ + MAX_SEQ_SZ * 2,
                                /* use bigger Sphincs size */
#else
...
enum Key_Sum {
    ...
    Dilithiumk = 258,   /* OID for Dilithium unknown yet  */
    Falconk    = 259,   /* OID for Falcon unknown yet */
    Sphincsk   = 260,   /* OID for Sphincs unknown yet */
    XMSSk      = 261    /* OID for XMSS unknown yet */
};
...
struct SignatureCtx {
    ...
    byte* sigCpy;
#endif
#if defined(HAVE_ECC) || defined(HAVE_ED25519) || defined(HAVE_ED448) || defined(HAVE_DILITHIUM) || \
    defined(HAVE_FALCON) || defined(HAVE_SPHINCS) || defined(HAVE_XMSS) || !defined(NO_DSA)
    int verify;
#endif
    union {
    #ifdef HAVE_DILITHIUM
        struct DilithiumKey* dilithium;
    #endif
    #ifdef HAVE_FALCON
        struct FalconKey* falcon;
    #endif
    #ifdef HAVE_SPHINCS
        struct SphincsKey* sphincs;
    #endif
    #ifdef HAVE_XMSS
        struct XmssKey* xmss;
    #endif
