        ...
        if (version >= 4) {
            ...
            if (onlyKeyShare == 2) {
                if (useX25519 == 1) {
                    ...
                    int groups[1] = { WOLFSSL_KYBER_512 };
                    ...
                    if (wolfSSL_set_groups(ssl, groups, 1) != WOLFSSL_SUCCESS) {
                        err_sys("unable to set groups: Kyber 512");
                    }
        #elif defined(HAVE_KYBER_768)
                    int groups[1] = { WOLFSSL_KYBER_768 };
                    ...
                    if (wolfSSL_set_groups(ssl, groups, 1) != WOLFSSL_SUCCESS) {
                        err_sys("unable to set groups: Kyber 768");
                    }
        #elif defined(HAVE_KYBER_1024)
                    int groups[1] = { WOLFSSL_KYBER_1024 };
                    ...
                    if (wolfSSL_set_groups(ssl, groups, 1) != WOLFSSL_SUCCESS) {
                        err_sys("unable to set groups: Kyber 1024");
                    }
        #endif
                }
                else {
