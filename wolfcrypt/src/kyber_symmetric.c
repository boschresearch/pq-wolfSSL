...
**************************************************/
static void shake128_absorb(uint64_t *state, const uint8_t *in, unsigned int inlen)
{
...
**************************************************/
static void shake128_squeezeblocks(uint8_t *out, size_t nblocks, uint64_t *state)
{
...
**************************************************/
void kyber_shake128_absorb(keccak_state *s, const uint8_t *seed, uint8_t x, uint8_t y)
{
  ...
  extseed[i++] = x;
  extseed[i]   = y;
  shake128_absorb(s->s, extseed, sizeof(extseed));
}
